...
if tipo_calcolo == 'Ditta Individuale' or tipo_calcolo == 'Professionista':
    ...
    if submitted:
        ...
        }, index=["Carico Fiscale (Saldo IRPEF)", "Carico Contributivo (INPS) al lordo dei minimali già versati ", "CARICO TOTALE (Fisco + INPS) al lordo dei contributi minimali già versati "])
...
#==============================================================================
    ...
    if submitted_soc:
        ...
        for i, socio in enumerate(soci_inputs):
            ...
            }, index=["Carico Fiscale (Saldo IRPEF)", "Carico Contributivo (INPS) al lordo dei minimali già versati", "CARICO TOTALE (Fisco + INPS) al lordo dei minimali già versati"])
            st.table(df_socio)
