...
#==============================================================================
# --- FUNZIONI DI CALCOLO (UNIVERSALI) ---
#==============================================================================
...
#==============================================================================
# --- IMPOSTAZIONI DELL'APP STREAMLIT ---
#==============================================================================
...
if tipo_calcolo == 'Ditta Individuale':
    ...
    if submitted:
        ...
        df_risultati = pd.DataFrame({"Descrizione": ["Base Imponibile IRPEF", "Imposta Lorda", "Imposta Netta", "Imposta Sostitutiva", "TOTALE CARICO FISCALE"],
                                     "Senza Concordato": [base_imp_no_cpb, imp_lorda_no_cpb, imp_netta_no_cpb, 0, carico_fiscale_no_cpb],
                                     "Con Concordato": [base_imp_si_cpb, imp_lorda_si_cpb, imp_netta_si_cpb, imp_sostitutiva, carico_fiscale_si_cpb]}).set_index("Descrizione")
...
# ==============================================================================
    ...
    if submitted_soc:
        ...
        for i, socio in enumerate(soci_inputs):
            ...
            quota_reddito_simulato = reddito_simulato_2024_soc * perc_socio; quota_reddito_rilevante = reddito_rilevante_cpb_2023_soc * perc_socio
            quota_reddito_proposto = reddito_proposto_cpb_2024_soc * perc_socio; quota_reddito_rettificato_cpb = reddito_impresa_rettificato_cpb_soc * perc_socio
